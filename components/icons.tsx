...
export function IconTire({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconDent({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M9 12c0-1.5 1.5-3 3-3s3 1.5 3 3-1.5 3-3 3" />
    </svg>
  );
}

export function IconWindshield({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconSeat({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M5 18h14a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2z" />
