  ...
  return (
    <Card className="overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 flex items-center justify-center border border-emerald-500/30">
              <IconTrendingUp className="w-6 h-6 text-emerald-400" />
            </div>
          </div>
          <div>
            <h3 className="font-bold text-white text-lg">Equity Over Time</h3>
      ...
      <div className="relative overflow-x-auto">
        ...
        {hoveredData && (
          <div
            className="absolute pointer-events-none bg-slate-800 border border-slate-700 rounded-xl p-3 shadow-xl z-10"
            style={{
          ...
          >
            <div className="text-xs text-slate-400 mb-2">Month {hoveredData.month}</div>
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400">Lease Spent:</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400">Car Value:</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-700/50">
        <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
          <div className="flex items-center gap-2 mb-1">
            <IconKey className="w-4 h-4 text-emerald-400" />
            <span className="text-xs text-emerald-400">Final Equity</span>
          </div>
        ...
        <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-amber-400">Lease Total</span>
          </div>
          <div className="text-xl font-bold text-white">
