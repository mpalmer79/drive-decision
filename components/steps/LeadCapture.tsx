  ...
  return (
    <Card className="mb-8">
      <div className="flex items-center justify-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-semibold text-slate-900">Ready to Move Forward?</h3>
          <p className="text-sm text-slate-500">Connect with a Quirk specialist</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-100 border border-slate-300 rounded-xl pl-10 pr-4 py-3 text-slate-900 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 transition-all"
            />
          </div>
        </div>
        ...
        {/* Notes */}
        <div>
          <label className="block text-sm font-medium text-slate-600 mb-1.5 text-center">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-slate-100 border border-slate-300 rounded-xl px-4 py-3 text-slate-900 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500 transition-all resize-none"
          />
        </div>
